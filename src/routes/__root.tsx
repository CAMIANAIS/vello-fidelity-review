  ...
  head: () => ({
    meta: [
      ...
      { title: "Vello ProviderCard — Design Fidelity Audit" },
      {
        name: "description",
        content:
          "A section-by-section engineering and design fidelity audit of one AI-built Vello component.",
      },
      { name: "author", content: "Camila Anais Mamani Cruz" },
      { property: "og:title", content: "Vello ProviderCard — Design Fidelity Audit" },
      {
        property: "og:description",
        content:
          "Token drift, accessibility findings, a measurable guardrail test, and the questions still open for design.",
      },
