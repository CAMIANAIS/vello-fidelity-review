      ...
      <div className="mx-auto max-w-5xl gap-10 px-5 pb-24 sm:px-8 lg:flex lg:max-w-6xl">
        ...
        <main className="min-w-0 flex-1 space-y-8">
          ...
          >
            ...
            <ul className="space-y-3">
              <li>
                ...
                Keeps every trust mark consistent across the app, so a requester learns to recognize
                it once and trusts it everywhere.
              </li>
              <li>
                <strong className="text-text-strong">Shape plus color, never color alone.</strong> A
                shield rebuilt as a plain circle isn’t a small style slip, it’s the accessible
                signal the trust bet depends on, gone.
              </li>
              <li>
                <strong className="text-text-strong">Real labels, real keyboard access.</strong> If
                only sighted mouse users can perceive who’s verified, the trust mechanism silently
          ...
          >
            ...
            <Quote>
              Fixing card padding to the token scale (15px → 20px) made the build more token-correct
              but <em>less</em> pixel-faithful to the actual reference, because the reference itself
              doesn’t follow its own scale. The walk-chip’s padding and the card’s 14px gap are
              exact matches to real, off-token production code.
            </Quote>
          ...
          >
            ...
            <div className="rounded-[var(--radius-md)] border border-border bg-muted/50 p-[var(--space-5)]">
              ...
              <p className="mt-3">
                ...
                which changes the header layout. Noted as a real tradeoff, not fixed silently either
                way.
              </p>
            </div>
          </Section>
            ...
            <div className="grid gap-[var(--space-4)] sm:grid-cols-2">
              <div className="rounded-[var(--radius-md)] border border-border bg-card p-[var(--space-5)] shadow-brand">
                ...
                <p className="mt-[var(--space-4)]">
                  ...
                  label, and the keyboard bug each needed a separate, hand-written fix instruction,
                  one round at a time.
                </p>
              </div>
          ...
          >
              ...
              {[
                {
                  ...
                  flag: "Done now: the task asked for two documented pushbacks against the first process map. That back-and-forth happened live in session and wasn’t written down at the time. It’s written down now, below.",
                  links: [
                    {
                      label: "Process map artifact ↗",
                      href: "https://claude.ai/artifact/6v2sxFt3rQra9iUA6tabLu",
                    },
                    {
                      label: "One-page reflection + pushbacks",
                      href: "/deliverables/monday-reflection.md",
                    },
                  ],
                },
                {
                  ...
                  flag: "Failure caught: the first pass counted Theme 1 as 5/6 participants in support. Auditing back to verbatim quotes showed P02 was a direct contradiction, he wants formal verification, not just vouching. Corrected to “2 strong, 2 adjacent, 1 direct contradiction”: materially weaker, and more honest.",
                  links: [
                    {
                      label: "Problem statements + entities",
                      href: "/deliverables/tuesday-problem-statements.md",
                    },
                  ],
                },
                {
                  ...
                  flag: "Known failure, not yet closed: that session had no access to the live design system, so the flow came from generic marketplace patterns, not Vello’s real admin screens. Its “named gap” is a hypothesis, not a verified diff.",
                  links: [
                    {
                  ...
                  figures: [
                    {
                      ...
                      caption:
                        "Requester site map, screenshotted directly since the Lucidchart link needs a login",
                    },
                    {
                      src: lucidSchema,
                ...
                },
                {
                  ...
                  flag: "Only the human caught: wrong badge component/variant, redundant icon + text, and the trust-hierarchy note. Only the AI caught: touch-target size, the keyboard/focus bug, a color-only signal, and a 4.51:1 contrast risk. Overlap: none, fully complementary.",
                },
                {
                  ...
                  flag: "Prompt v2 swapped the vague “attached design system” for the actual colors.css, spacing.css and typography.css contents, after discovering the docs page is a JS app with nothing a tool can read.",
                },
              ].map((d) => (
                <article
                  key={d.day}
            ...
            <Quote source="Thursday verified-badge check, against Monday’s own artifact">
              “Olive shield, never a dot,” checked directly against the real card: it <em>is</em> a
              shield. Not a violation. A hypothesis tested and disproved, kept as a legitimate
              finding rather than discarded.
            </Quote>
            <div className="rounded-[var(--radius-md)] border border-border bg-muted/50 p-[var(--space-5)]">
              ...
              {[
                {
                  ...
                  week: "Separated which research questions were already answerable from existing data (drop-off %, response-time %) from which genuinely needed real interviews.",
                ...
                },
                {
                  ...
                  week: "Caught that “post a need” vs. “browse providers” implies two different Booking-to-ServiceRequest relationships, before the flow was finalized.",
                  avoid:
                ...
                },
                {
                  ...
                  week: "Built and audited the card’s Success, No-rating, No-photo and Unavailable states explicitly.",
                  avoid:
                    "Swapping the real design for a shortcut mid-build, without telling anyone.",
                },
                {
                  phase: "Validate",
                  doThis:
                    "Add real tracking and real checks on the real feature with real data, not a synthetic case that hides the actual problem.",
                  week: "Checked actual token values and a real contrast ratio (5.69:1) instead of eyeballing “looks fine.”",
                ...
                },
                {
                  ...
                  week: "Every fix instruction named the exact token (--success, --shadow-lg, --paper) instead of “make it look right.”",
